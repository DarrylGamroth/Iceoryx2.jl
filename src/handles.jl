...
mutable struct EntryHandle
    handle::Iceoryx2FFI.iox2_entry_handle_h
    function EntryHandle(handle::Iceoryx2FFI.iox2_entry_handle_h)
        obj = new(handle)
        finalizer(_finalize_EntryHandle, obj)
        return obj
    end
end

@inline unsafe_handle(obj::EntryHandle) = obj.handle
@inline Base.isvalid(obj::EntryHandle) = obj.handle != _IOX2_NULL
@inline invalidate!(obj::EntryHandle) = (obj.handle = _IOX2_NULL)

function _finalize_EntryHandle(obj::EntryHandle)
    if obj.handle != _IOX2_NULL
        Iceoryx2FFI.iox2_entry_handle_drop(obj.handle)
        obj.handle = _IOX2_NULL
    end
    return nothing
end
...
function Base.close(obj::EntryHandle)
    _finalize_EntryHandle(obj)
    return nothing
end

mutable struct EntryHandleMut
    handle::Iceoryx2FFI.iox2_entry_handle_mut_h
    function EntryHandleMut(handle::Iceoryx2FFI.iox2_entry_handle_mut_h)
        obj = new(handle)
        finalizer(_finalize_EntryHandleMut, obj)
        return obj
    end
end

@inline unsafe_handle(obj::EntryHandleMut) = obj.handle
@inline Base.isvalid(obj::EntryHandleMut) = obj.handle != _IOX2_NULL
@inline invalidate!(obj::EntryHandleMut) = (obj.handle = _IOX2_NULL)

function _finalize_EntryHandleMut(obj::EntryHandleMut)
    if obj.handle != _IOX2_NULL
        Iceoryx2FFI.iox2_entry_handle_mut_drop(obj.handle)
        obj.handle = _IOX2_NULL
    end
    return nothing
end
...
function Base.close(obj::EntryHandleMut)
    _finalize_EntryHandleMut(obj)
    return nothing
end

mutable struct EntryValueUninit
    handle::Iceoryx2FFI.iox2_entry_value_uninit_h
    function EntryValueUninit(handle::Iceoryx2FFI.iox2_entry_value_uninit_h)
        obj = new(handle)
        finalizer(_finalize_EntryValueUninit, obj)
        return obj
    end
end

@inline unsafe_handle(obj::EntryValueUninit) = obj.handle
@inline Base.isvalid(obj::EntryValueUninit) = obj.handle != _IOX2_NULL
@inline invalidate!(obj::EntryValueUninit) = (obj.handle = _IOX2_NULL)

function _finalize_EntryValueUninit(obj::EntryValueUninit)
    if obj.handle != _IOX2_NULL
        Iceoryx2FFI.iox2_entry_value_uninit_drop(obj.handle)
        obj.handle = _IOX2_NULL
    end
    return nothing
end
...
function Base.close(obj::EntryValueUninit)
    _finalize_EntryValueUninit(obj)
    return nothing
end
