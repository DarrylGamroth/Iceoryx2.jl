...
function main()
    ...
    Iceoryx2.create(node_builder; service_type = :ipc) do node
        ...
        pubsub_builder = Iceoryx2.pub_sub(service_builder)
        Iceoryx2.payload_type!(pubsub_builder, UInt64)

        Iceoryx2.open_or_create(pubsub_builder) do factory
            Iceoryx2.create(Iceoryx2.publisher_builder(factory, UInt64)) do publisher
                Iceoryx2.create(Iceoryx2.subscriber_builder(factory, UInt64)) do subscriber
