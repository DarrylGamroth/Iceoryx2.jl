...
- Status: Completed (2026-01-27)
  ...
  - Update (2026-01-27): added scalar `loan_uninit` helpers and `write_payload!` overloads for pub/sub and request/response; added `payload_ptr`/`payload_mut_ptr` convenience accessors.
