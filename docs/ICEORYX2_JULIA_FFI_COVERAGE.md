...
- C ABI bindings: `src/generated/Iceoryx2FFI.jl`

Notes:
- Julia mapping lists the primary implementation files.
- Handle types generally live in `src/generated/handles.jl`; raw ABI bindings live in `src/generated/Iceoryx2FFI.jl`.
...
- `attribute.cpp`
  ...
  - Julia: `src/generated/handles.jl` (AttributeRef), `src/attributes.jl` (key/value + view helpers).
- `attribute_set.cpp`
  ...
  - Julia: `src/generated/handles.jl` (AttributeSet/AttributeSetView), `src/attributes.jl` (indexing + key/value access), `src/callbacks.jl` (each_attribute_value/attribute_values + callback progression).
- `attribute_specifier.cpp`
  ...
  - Julia: `src/generated/handles.jl` (AttributeSpecifier), `src/attributes.jl` (AttributeSpecifier(), define!, attributes).
- `attribute_verifier.cpp`
  ...
  - Julia: `src/generated/handles.jl` (AttributeVerifier), `src/attributes.jl` (AttributeVerifier(), require!/require_key!, verify_requirements, attributes).
- `event_id.cpp`
  - C: `iox2_event_id_t`
...
- `header_publish_subscribe.cpp`
  ...
  - Julia: `src/generated/handles.jl` (PublishSubscribeHeader/PublishSubscribeHeaderRef only). Header accessors not wrapped yet.
- `header_request_response.cpp`
  ...
  - Julia: `src/generated/handles.jl` (RequestHeader/ResponseHeader + refs only). Header accessors not wrapped yet.
...
- `node_id.cpp`
  ...
  - Julia: `src/generated/handles.jl` (NodeId/NodeIdView), `src/nodes.jl` (value_high/value_low/pid/creation_time/to_owned).
- `node_name.cpp`
  ...
  - Julia: `src/generated/handles.jl` (NodeName/NodeNameView), `src/strings.jl` (string conversions + constructors).
- `service.cpp`
...
- `service_name.cpp`
  ...
  - Julia: `src/generated/handles.jl` (ServiceName/ServiceNameView), `src/strings.jl` (string conversions + constructors).
- `unique_port_id.cpp`
  ...
  - Julia: `src/generated/handles.jl` (Unique*Id handles), `src/ids.jl` (id() accessors, bytes(), ==, isless).
...
- `port_factory_event.cpp`
  ...
  - Julia: `src/messaging.jl` (PortFactoryEvent + listener/notifier builders), `src/generated/handles.jl` (handle refs). Missing: attributes/nodes/service_name/service_id/static_config accessors.
- `port_factory_notifier.cpp`
  ...
  - Julia: `src/messaging.jl` (NotifierBuilder + default_event_id!), `src/generated/handles.jl` (Notifier handle).
...
- `waitset.cpp`
  ...
  - Julia: `src/waitset.jl` (Waitset + builder + attach_* + wait_and_process* + attachment IDs/guards), `src/generated/handles.jl` (waitset handle types).
...
- `dynamic_config_publish_subscribe.cpp`
  ...
  - Julia: `src/config.jl` (list_publishers/list_subscribers/number_of_*), `src/generated/handles.jl` (PublisherDetailsView/SubscriberDetailsView). Per-detail accessors not wrapped yet.
- `dynamic_config_request_response.cpp`
  ...
  - Julia: `src/config.jl` (list_clients/list_servers/number_of_*), `src/generated/handles.jl` (ClientDetailsView/ServerDetailsView). Per-detail accessors not wrapped yet.
- `static_config.cpp`
...
- `client_details.cpp`
  ...
  - Julia: `src/generated/handles.jl` (ClientDetailsView), `src/config.jl` (list_clients). Per-field accessors not wrapped yet.
- `listener_details.cpp`
  ...
  - Julia: `src/generated/handles.jl` (ListenerDetailsView), `src/config.jl` (list_listeners). Per-field accessors not wrapped yet.
...
- `notifier_details.cpp`
  ...
  - Julia: `src/generated/handles.jl` (NotifierDetailsView), `src/config.jl` (list_notifiers). Per-field accessors not wrapped yet.
...
- `file_descriptor.cpp`
  ...
  - Julia: `src/generated/handles.jl` (FileDescriptor/FileDescriptorView), `src/waitset.jl` (listener file_descriptor + waitset attach). `file_descriptor_new` and native_handle accessors are not wrapped yet.
- `node_state.cpp`
